...
static void mfc_set_encode_init_param(struct mfc_inst_ctx *mfc_ctx, union mfc_args *args)
{
	...
	if (enc_init_mpeg4_arg->in_RC_frm_enable) {
		enc_init_mpeg4_arg->in_RC_framerate = enc_init_mpeg4_arg->in_RC_framerate * 1000;
		WRITEL(enc_init_mpeg4_arg->in_RC_framerate, MFC_RC_FRAME_RATE); /* changed for MAIN LINE MFC FW */
