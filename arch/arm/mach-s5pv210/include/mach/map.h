...
#define S5P_VA_BUS_AXI_VSYS     S3C_ADDR_CPU(0x10000)
#define S5PV210_PA_BUS_AXI_VSYS (0xF1200000)
        
#define S5P_VA_BUS_AXI_XSYS     S3C_ADDR_CPU(0x18000)
#define S5PV210_PA_BUS_AXI_XSYS (0xFAC00000)
